...
import { LayoutDashboard, BookOpen, PlusCircle, Users, Settings, LogOut } from 'lucide-react'
    ...
    <aside className="w-64 bg-white border-r border-gray-100 min-h-screen fixed left-0 top-0 flex flex-col">
      <div className="p-6 border-b border-gray-100">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg text-dark">Coursify</span>
        </Link>
      </div>
      ...
      <div className="p-4 border-t border-gray-100 space-y-1">
        <Link to="/profile" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">
          <Settings size={18} />
          Profil
        </Link>
